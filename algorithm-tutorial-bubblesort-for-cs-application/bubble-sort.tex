...
\usetikzlibrary{mindmap, arrows.meta, shapes, positioning, calc, backgrounds, fit, 
	decorations.pathmorphing, decorations.shapes, decorations.markings}
...
% \subtitle{(What are Algorithms, How to Design Algorithms, \\and How to Analyze Algorithms)}
\subtitle{(A Taste of Algorithms: Definition, Design, and Analysis)}
...
\input{sections/sorting-problem}
\input{sections/bubble-sort}
\input{sections/bubble-sort-analysis}
