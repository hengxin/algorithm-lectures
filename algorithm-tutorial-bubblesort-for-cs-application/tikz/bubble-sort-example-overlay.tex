...
\uncover<11->{
  \draw [bubble = 15] (04) to node[sloped, rotate = 90, above = 5pt, violet] {Bubbled Up} (44);
}

\uncover<12->{
  \draw [bubble = 15] (33) to node[sloped, rotate = 90, above = 5pt, violet] {Bubbled Up} (73);
}
\end{tikzpicture}
